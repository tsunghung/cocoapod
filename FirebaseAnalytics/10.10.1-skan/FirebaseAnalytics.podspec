Pod::Spec.new do |s|
    ...
    s.source           = {
        :http => 'https://dl.google.com/firebase/ios/analytics/e689cf4152284d0f/FirebaseAnalytics-10.10.1.tar.gz'
    }
    ...
    s.subspec 'AdIdSupport' do |ss|
        ss.dependency 'GoogleAppMeasurement', '10.10.1-skan'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end

    s.subspec 'WithoutAdIdSupport' do |ss|
        ss.dependency 'GoogleAppMeasurement/WithoutAdIdSupport', '10.10.1-skan'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end
