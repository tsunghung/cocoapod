Pod::Spec.new do |s|
    ...
    s.source           = {
        :http => 'https://tsunghung.github.io/GoogleAppMeasurement-10.17.0.tar.gz'
    }
    ...
    s.subspec 'AdIdSupport' do |ss|
        ss.dependency 'GoogleAppMeasurement/WithoutAdIdSupport', '10.17.0'
    ...
    s.subspec 'WithoutAdIdSupport' do |ss|
        ...
        ss.resource_bundles = { 'GoogleAppMeasurementResource' => "PrivacyInfo.xcprivacy" }
    end
